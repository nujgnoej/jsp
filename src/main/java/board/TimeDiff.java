...
public class TimeDiff {
	// 1.'오늘날짜(1)'와 'DB의 날짜(2)'를 '문자'형식으로 변경시킨다. - '날짜'형식기호에 맞도록 설계할것
	...
	public int timeDiff(String wCdate) {
		...
		// 3. 날짜형식으로 변경된 두 자료(today/dateWdate)를 숫자형식(getTime())으로 변경처리한다.(시간으로 연산처리하기 위함) : 결과값ms(1/1000초)형식으로 반환한다.

  ...
  <form name="myForm" method="post" action="${ctp}/memUpdatePwdOk.mem" class="was-validated">
	  ...
	  <table class="table table-bordered">
	    <tr>
	      <th>기존 비밀번호</th>
	      <td>
	        <input type="password" name="originalPwd" id="originalPwd" placeholder="기존 비밀번호를 입력하세요." autofocus required class="form-control"/>
	      </td>
	    </tr>
	    <tr>
	      <th>새 비밀번호</th>
	      <td>
	      	<input type="password" name="newPwd" id="newPwd" required placeholder="변경할 비밀번호를 입력하세요." class="form-control"/>
	      </td>
	    </tr>
	    <tr>
	      <th>새 비밀번호 한번더</th>
	      <td>
	      	<input type="password" name="rePwd" id="rePwd" required placeholder="변경할 비밀번호를 다시 입력하세요." class="form-control"/>
	      </td>
	    </tr>
	    <tr>

...
insert into member values (default, 'admin','1234','관리맨','관리자',default,default,'010-4079-8492','충청북도 청주시 상당구 낙영로12번길 25, 3층','junmo8492@naver.com','https://blog.naver.com/junmo8492','프리랜서','등산/바둑',default,'관리자입니다.',default,default,default,default,default,default,default,default);
